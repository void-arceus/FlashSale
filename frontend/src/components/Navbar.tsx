                ...
                <div className="flex items-center">
                    {isLoggedIn ? (
                        ...
                        <button
                            ...
                            className="px-5 py-2 text-sm font-medium bg-btn-primary hover:bg-btn-hover rounded-xs text-btn-text cursor-pointer active:scale-[0.96]  shadow-sm hover:shadow-md"
                        >
                            Login/Register
                        </button>
                    )}
