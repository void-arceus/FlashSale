...
const PRODUCT_ID = "6a6ae48e144ed7995171c8c6";
...
// --- SETUP PHASE (Runs once per test run) ---
export function setup(): SetupData {
    ...
    // Extract the Set-Cookie header returned by Express
...
// --- TEST PHASE (Runs continuously across VUs) ---
export default function (data: SetupData): void {
    ...
    const params = {
        headers: {
            "Content-Type": "application/json",
            Cookie: data.cookieHeader, // Attach the session cookie
        },
    };
    ...
    sleep(0.1); // Small pacing delay between requests per VU
}
